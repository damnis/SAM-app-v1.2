...
#    "BSTR": "Bitcoin Standard Treasury Co.",
    ...
    "GLXY": "Galaxy Digital Holdings Ltd.",    # mining en asset-management
    "HUT": "Hut 8 Mining Corp.",             # grote Bitcoin-miner
    "IBIT": "iShares Bitcoin Trust (BlackRock)",
    "FBTC": "Fidelity Wise Origin Bitcoin Fund",
    "BTC": "Grayscale Bitcoin Mini Trust (Spot BTC trust)",
...
#    "DFDEV": "DeFi Development Corp. (Solana treasury exposure)",  # :contentReference[oaicite:3]{index=3}
    ...
    # ☀️ Solana‑gerelateerde producten
    "SSK": "REX‑Osprey Sol + Staking ETF (spot Solana)",
    "GSOL": "Grayscale Solana Trust (spot SOL)"
}
