...
def bepaal_grafiekperiode(interval):
    if interval == "15m":
        ...
        return timedelta(days=365)      # 180=6 maanden à 1 candle per dag
    elif interval == "1wk":
