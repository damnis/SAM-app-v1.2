...
def determine_advice(df, threshold, risk_aversion=0):
    ...
    if risk_aversion == 0:
        ...
        for i in range(2, len(df)):
            ...
            if stage_1 >= 1.5 and stage_2 >= 1.5 and stage_1 > 0 and stage_2 > 0 and stage_3 > 0 and stage_4 > 0 and stage_5 > 0 and
            trend_1 >= trend_2 and sam_1 > 0 and sam_2 > 0 and sam_1 >= sam_2 and trends_1 > trends_2 and trend_1 > 0:
                df.at[df.index[i], "Advies"] = "Kopen"
