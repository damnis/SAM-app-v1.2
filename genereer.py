...
#    if not toon_matrix:
  #      return
    ...
    INTERVALLEN_CRYPTO = {
        "1wk": {"stappen": 3, "breedte": 818, "hoogte": 20, "label": "Week", "show_text": True},
        "1d": {"stappen": 21, "breedte": 119.2, "hoogte": 20, "label": "Dag", "show_text": True},
        "4h": {"stappen": 126, "breedte": 19.731, "hoogte": 10, "label": "4u", "show_text": True},
