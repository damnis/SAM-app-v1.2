...
#    if not toon_matrix:
  #      return
    ...
    INTERVALLEN = {
        ...
        "1d": {"stappen": 15, "breedte": 60, "hoogte": 20, "label": "Dag", "show_text": True},
        "4h": {"stappen": 45, "breedte": 15.3, "hoogte": 10, "label": "4u", "show_text": True},
        "1h": {"stappen": 135, "breedte": 4.6, "hoogte": 10, "label": "1u", "show_text": True},
        "15m": {"stappen": 540, "breedte": 1.2, "hoogte": 6, "label": "15m", "show_text": False}
    }
